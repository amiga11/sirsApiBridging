...
export const rlLimaTitikTiga = databaseSIRS.define("rl_lima_titik_tiga", {
  rs_id: {
...
icd10.hasMany(rlLimaTitikTigaDetail, { foreignKey: "code" });
rlLimaTitikTigaDetail.belongsTo(icd10, {
  foreignKey: "kode_icd_10",
});

// icd10.hasMany(rlLimaTitikTigaDetail, { foreignKey: "description" });
// rlLimaTitikTigaDetail.belongsTo(icd10, {
//   foreignKey: "deskripsi",
// });
